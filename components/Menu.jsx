...
const menuItems = [
  ...
  },
  {
    imgSrc: "/assets/menu/coffee-5.png",
    name: "Irish Coffee",
    description: "Coffee with Irish whisket and cream",
    price: 6.5,
  },
];
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">
            ...
            quam ea similique possimus quisquam animi quod hic, maxime
            perspiciatis! Repudiandae ducimus vel labore illo molestias
            quibusdam ad enim impedit!
          </p>
        </div>
        {/* menu & btn */}
